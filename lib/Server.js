...
Server.prototype.listen = function() {
	...
	sockServer.on("connection", function(conn) {
		...
		//Bug https://github.com/sockjs/sockjs-node/issues/121
		if (!conn) {
			console.error("sockServer.on('connection') was triggered with no connection. See https://github.com/sockjs/sockjs-node/issues/121");
			return;
		}
